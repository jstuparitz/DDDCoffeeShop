...
namespace CoffeeShop.RetailOrdering.Domain.Credit_Card_Validation
{
    class VisaValidator : CreditCardValidator
    {
        ...
        public VisaValidator(int[] newCardNumber,DateTime newExpirationDate) 
        ...
        public override void validate()
        {
            ...
            AssertionConcern.AssertArgumentMatches("4", startOfCardNumber, INVALID_CARD_NUMBER_ERROR_MESSAGE);
